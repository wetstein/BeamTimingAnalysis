...
The impact of energy uncertainty on precision oscillation measurements. How slices in energy spectra can control that systematic. 
...
\section{Achieving 100 psec vertex resolutions in Theia}



\section{Achieving 100 psec vertex resolution in DUNE}
